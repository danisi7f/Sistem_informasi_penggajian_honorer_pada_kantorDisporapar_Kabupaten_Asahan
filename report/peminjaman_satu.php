            ...
            <div class='row'>
                <div class="col-sm-12">
                    ...
                    <div class="text-center">
                        ...
                        <h4> Jalan Madong Lubis <br> Kabupaten Asahan, Sumatera Utara, 21223</h4>
                        <hr>
                        ...
                        <table class="table table-bordered table-striped table-hover">
                            <tbody>
                                ...
                                <tr>
                                    <td>Alamat Pegawai</td> <td><?= $data['alamat'] ?></td>
                                </tr>
								<tr>
                                    <td>Gaji</td> <td><?= $data['gaji'] ?> hari</td>
                                </tr>
                            ...
                            <tfoot>
                                <tr>
                                    <td colspan="2" class="text-right">
                                        Kisaran  <?= date("d-m-Y") ?>
                                        <br><br><br><br>
                                        <u>Kabag Kepemudaan, S.Hum<strong></u><br>
                                        NIP.102871291416712
									</td>
								</tr>
							</tfoot>
