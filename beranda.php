    ...
    <div class="row">
        <div class ="col-xs-12">
            ...
            <div class="alert alert-success">
                <strong><marquee bgcolor="blue", behavior="alternate", scrollamount="12">Selamat Datang di SI PENGGAJIAN HONORER PADA KANTOR DISPORAPAR KABUPATEN ASAHAN</marquee></strong>
            </div>
        </div>
    </div>
    <div class="row">
        ...
        <div class="col-sm-9 col-xs-12">
            <div class="panel panel-default">
                <div class="panel-heading">
                    <h3 class="panel-title">DATA STAF PEGAWAI HONORER</h3>
                </div>
                <div class="panel-body">
                     <table id="dtskripsi" class="table table-bordered table-striped table-hover">
                        ...
                        <tbody>
                            ...
                            $sql = "SELECT * FROM data_penggajian";
